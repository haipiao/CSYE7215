...
public class Simulation {
	...
	// INVARIANT: Threads of Cook, Machine and Customer should not exceed its max capacity number.
...
//			while (if all orders are not finished) {
//				synchronized (Finished lock){
//					// Lock changed to wait status.
//				}
//			}
//
