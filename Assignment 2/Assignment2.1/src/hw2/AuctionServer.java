...
//			if("Seller is not exist in the list"){
//				// add the seller into the list of sellers
//			}
//
//			if("seller does not have too many items"){
//				// put item into list
...
//			if (the item can be bid upon){
//				if (bidder biddingh number< maximum){
//					currentBiddingInfo = get Current bidding info;
//					if(currentBiddingInfo<highestBids){
//						if(biddingAmount > lowestBidding){
//							NowBidding = currentBiddingInfo;
//							bidding number ++;
//						}
//					}
//				}
